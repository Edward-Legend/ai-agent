<template>
  <div class="home-container">
    ...
    <div class="apps-container">
      <div class="app-card" @click="navigateTo('/game-ranking')">
        <div class="card-glow"></div>
        <div class="app-icon game-icon">🎮</div>
        <div class="app-info">
          <div class="app-title">游戏排行智能分析</div>
          <div class="app-desc">自动检索游戏行业榜单、流量数据，提供专业的比较和分析功能</div>
        </div>
...
useHead({
  ...
  meta: [
    ...
    {
      name: 'keywords',
      content: '游戏排行,游戏分析,游戏榜单,游戏数据,AI分析,游戏行业,智能分析'
    }
  ]
})
